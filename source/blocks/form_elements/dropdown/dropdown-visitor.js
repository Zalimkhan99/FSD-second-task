$(document).ready(function(){
  ...
  $(".dropdown__icons").click(function(){
...
// минус
    ...
    function sum() {
        let dropdownName= document.querySelector('.dropdown__text')
        let adult = $(".adult");
        let child = $(".child");
        let babes = $(".babes");
    ...
    function clean() {
        ...
        let babes = $(".babes");
        let allValue = parseInt(adult.html()) + parseInt(child.html()) + parseInt(babes.html());
        let visual= $('.dropdown-lists__button_clean')
    ...
    $('.dropdown-lists__button_clean').click(function ($count) {
        let adult = $(".adult");
        let child = $(".child");
        let babes = $(".babes");
        let dropdownName= document.querySelector('.dropdown__text')
    ...
    $('.dropdown-lists__button_apply').click(function () {
